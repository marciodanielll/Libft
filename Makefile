...
#    Updated: 2024/10/30 19:44:29 by mhermini         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
clean:
	...
	@ rm -f $(BONUS_COMPILED)
	@ echo "\033[0;32mBonus compilation flag removed!\033[0m"
...
bonus: $(NAME) $(OBJ_BONUS) $(BONUS_COMPILED)

$(BONUS_COMPILED): $(OBJ_BONUS)
